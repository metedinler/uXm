...
& powershell.exe -NoProfile -ExecutionPolicy Bypass -File $Merkez -Komut 'derleyici_derle' -Kok $Kok -DerlemeYok:$DerlemeYok -IlkHata:$IlkHata -Adet $Adet -Basla $Basla -Ara $Ara -Zaman $Zaman -Uygula:$Uygula -BuildEmekli:$BuildEmekli
exit $LASTEXITCODE
