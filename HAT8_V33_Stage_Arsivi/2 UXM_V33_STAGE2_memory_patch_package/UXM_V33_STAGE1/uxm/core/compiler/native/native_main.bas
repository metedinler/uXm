...
Sub Main()
    ...
    Else
        Print "UX-MINIMA x64 V3.3-stage2 FreeBASIC compiler"
    ...
    Print "NASM:"
    Print "nasm -f win64 ";OutAsm;" -o build\obj\<ad>.obj"
    Print "FreeBASIC runtime ile link:"
    Print "fbc -x build\exe\<ad>.exe uxm\core\runtime\uxm31_runtime_fb_full.bas build\obj\<ad>.obj"
End Sub
