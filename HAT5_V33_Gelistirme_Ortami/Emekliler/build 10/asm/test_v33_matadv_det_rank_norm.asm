...
uxm_entry:
    ...
    mov dword [ux_mem + 74140] , 1
    mov dword [ux_mem + 74144] , 1
    mov dword [ux_mem + 74148] , 3
    mov dword [ux_mem + 74152] , 3
    mov dword [ux_mem + 74156] , 0
    mov dword [ux_mem + 74160] , 1
    mov dword [ux_mem + 74164] , 16
    mov dword [ux_mem + 74168] , 9
    mov dword [ux_mem + 74172] , 25
    mov dword [ux_mem + 74176] , 3
    mov dword [ux_mem + 74180] , 1
    mov dword [ux_mem + 74184] , 0
    mov dword [ux_mem + 74188] , 0
    mov dword [ux_mem + 74192] , 2
    mov dword [ux_mem + 74196] , 0
    mov dword [ux_mem + 74200] , 0
    mov dword [ux_mem + 74204] , 0
    mov dword [ux_mem + 74208] , 3
    mov dword [ux_mem + 74212] , 0
    mov dword [ux_mem + 74216] , 0
    mov dword [ux_mem + 74220] , 0
    mov dword [ux_mem + 74224] , 4
    ; >
    inc rbx
    cmp rbx, TAPE_CELLS
    jae __ux_err_ptr
