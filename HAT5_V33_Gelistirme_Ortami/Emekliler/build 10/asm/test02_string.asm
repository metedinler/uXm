...
uxm_entry:
    ...
    mov byte [ux_mem + 36864], 77
    mov byte [ux_mem + 36865], 101
    mov byte [ux_mem + 36866], 114
    mov byte [ux_mem + 36867], 104
    mov byte [ux_mem + 36868], 97
    mov byte [ux_mem + 36869], 98
    mov byte [ux_mem + 36870], 97
    mov byte [ux_mem + 36871], 32
    mov byte [ux_mem + 36872], 85
    mov byte [ux_mem + 36873], 88
    mov byte [ux_mem + 36874], 45
    mov byte [ux_mem + 36875], 77
    mov byte [ux_mem + 36876], 73
    mov byte [ux_mem + 36877], 78
    mov byte [ux_mem + 36878], 73
    mov byte [ux_mem + 36879], 77
    mov byte [ux_mem + 36880], 65
    mov byte [ux_mem + 36881], 32
    mov byte [ux_mem + 36882], 86
    mov byte [ux_mem + 36883], 51
    mov byte [ux_mem + 36884], 46
    mov byte [ux_mem + 36885], 49
    mov byte [ux_mem + 36886], 10
    mov byte [ux_mem + 36887], 0
    ; p1
    mov ecx, 0
    mov edx, CELL_BITS
