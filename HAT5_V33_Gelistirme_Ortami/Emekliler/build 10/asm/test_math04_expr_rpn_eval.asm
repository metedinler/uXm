...
uxm_entry:
    ...
    mov byte [ux_mem + 37164] , 69
    mov byte [ux_mem + 37165] , 1
    mov byte [ux_mem + 37167] , 0
    mov byte [ux_mem + 37168] , 2
    mov byte [ux_mem + 37169] , 1
    mov byte [ux_mem + 37170] , 2
    mov byte [ux_mem + 37171] , 14
    mov byte [ux_mem + 37172] , 1
    mov byte [ux_mem + 37173] , 3
    mov byte [ux_mem + 37174] , 2
    mov byte [ux_mem + 37175] , 12
    mov byte [ux_mem + 37176] , 10
    mov byte [ux_mem + 37177] , 1
    mov byte [ux_mem + 37178] , 2
    mov byte [ux_mem + 37179] , 10
    mov byte [ux_mem + 37180] , 99
    mov byte [ux_mem + 37166] , 13
    ; >
    inc rbx
    cmp rbx, TAPE_CELLS
    jae __ux_err_ptr
