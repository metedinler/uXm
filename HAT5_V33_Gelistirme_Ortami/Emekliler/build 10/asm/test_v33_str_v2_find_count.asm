...
uxm_entry:
    ...
    mov byte [ux_mem + 73728], 66
    mov byte [ux_mem + 73729], 65
    mov byte [ux_mem + 73730], 78
    mov byte [ux_mem + 73731], 65
    mov byte [ux_mem + 73732], 78
    mov byte [ux_mem + 73733], 65
    mov byte [ux_mem + 73734], 0
    mov byte [ux_mem + 73744], 65
    mov byte [ux_mem + 73745], 78
    mov byte [ux_mem + 73746], 65
