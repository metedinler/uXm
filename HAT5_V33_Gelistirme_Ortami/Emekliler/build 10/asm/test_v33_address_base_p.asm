...
%define TAPE_BYTES 16384
%define STACK_BYTES 4096
%define DATA_BYTES 32768
%define QUEUE_BYTES 4096
%define STACK_OFFSET 16384
%define DATA_OFFSET 20480
...
uxm_entry:
    ...
    mov byte [ux_mem + 20490], 65
    mov byte [ux_mem + 20491], 66
    mov byte [ux_mem + 20492], 67
    mov byte [ux_mem + 20493], 0
    ; .(D:10+P)
    mov r10, rbx
    add r10, 10
    cmp r10, DATA_CELLS
    jae __ux_err_data
    lea r11, [r12 + DATA_OFFSET + r10]
    movzx rax, byte [r11]
    mov ecx, eax
    call ux_putc
    ; >
