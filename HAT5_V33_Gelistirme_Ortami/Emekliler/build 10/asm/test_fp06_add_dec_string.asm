...
uxm_entry:
    ...
    mov byte [ux_mem + 36864], 49
    mov byte [ux_mem + 36865], 50
    mov byte [ux_mem + 36866], 46
    mov byte [ux_mem + 36867], 51
    mov byte [ux_mem + 36868], 52
    mov byte [ux_mem + 36869], 0
    mov byte [ux_mem + 36884], 53
    mov byte [ux_mem + 36885], 46
    mov byte [ux_mem + 36886], 54
