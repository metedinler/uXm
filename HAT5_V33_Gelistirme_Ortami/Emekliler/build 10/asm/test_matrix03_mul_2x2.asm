; UX-MINIMA x64 V3.3-stage10fix generated NASM
default rel
global uxm_entry
global ux_mem
global ux_status
...
uxm_entry:
    ...
    mov byte [ux_mem + 36964] , 77
    mov byte [ux_mem + 36965] , 1
    mov byte [ux_mem + 36966] , 2
    mov byte [ux_mem + 36967] , 0
    mov byte [ux_mem + 36968] , 0
    mov byte [ux_mem + 36969] , 2
    mov byte [ux_mem + 36970] , 2
    mov byte [ux_mem + 36971] , 0
    mov byte [ux_mem + 36972] , 1
    mov byte [ux_mem + 36973] , 16
    mov byte [ux_mem + 36974] , 4
    mov byte [ux_mem + 36975] , 20
    mov byte [ux_mem + 36976] , 2
    mov byte [ux_mem + 36977] , 1
    mov byte [ux_mem + 36978] , 0
    mov byte [ux_mem + 36979] , 0
    mov byte [ux_mem + 36980] , 1
    mov byte [ux_mem + 36981] , 2
    mov byte [ux_mem + 36982] , 3
    mov byte [ux_mem + 36983] , 4
    mov byte [ux_mem + 37064] , 77
    mov byte [ux_mem + 37065] , 1
    mov byte [ux_mem + 37066] , 2
    mov byte [ux_mem + 37067] , 0
    mov byte [ux_mem + 37068] , 0
    mov byte [ux_mem + 37069] , 2
    mov byte [ux_mem + 37070] , 2
    mov byte [ux_mem + 37071] , 0
    mov byte [ux_mem + 37072] , 1
    mov byte [ux_mem + 37073] , 16
    mov byte [ux_mem + 37074] , 4
    mov byte [ux_mem + 37075] , 20
    mov byte [ux_mem + 37076] , 2
    mov byte [ux_mem + 37077] , 1
    mov byte [ux_mem + 37078] , 0
    mov byte [ux_mem + 37079] , 0
    mov byte [ux_mem + 37080] , 5
    mov byte [ux_mem + 37081] , 6
    mov byte [ux_mem + 37082] , 7
    mov byte [ux_mem + 37083] , 8
    ; >
    inc rbx
    cmp rbx, TAPE_CELLS
    jae __ux_err_ptr
