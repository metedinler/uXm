...
uxm_entry:
    ...
    mov byte [ux_mem + 36865], 66
    mov byte [ux_mem + 36866], 73
    mov byte [ux_mem + 36867], 84
    mov byte [ux_mem + 36868], 32
    mov byte [ux_mem + 36869], 67
    mov byte [ux_mem + 36870], 80
    mov byte [ux_mem + 36871], 85
    mov byte [ux_mem + 36872], 32
    mov byte [ux_mem + 36873], 84
    mov byte [ux_mem + 36874], 69
    mov byte [ux_mem + 36875], 83
    mov byte [ux_mem + 36876], 84
    mov byte [ux_mem + 36877], 10
    mov byte [ux_mem + 36878], 0
    mov byte [ux_mem + 36896], 65
    mov byte [ux_mem + 36897], 68
    mov byte [ux_mem + 36898], 68
    mov byte [ux_mem + 36899], 61
    mov byte [ux_mem + 36900], 0
    mov byte [ux_mem + 36904], 32
    mov byte [ux_mem + 36905], 67
    mov byte [ux_mem + 36906], 61
    mov byte [ux_mem + 36907], 0
    mov byte [ux_mem + 36912], 10
    mov byte [ux_mem + 36913], 0
    mov byte [ux_mem + 36920], 65
    mov byte [ux_mem + 36921], 78
    mov byte [ux_mem + 36922], 68
    mov byte [ux_mem + 36923], 61
    mov byte [ux_mem + 36924], 0
    mov byte [ux_mem + 36928], 88
    mov byte [ux_mem + 36929], 79
    mov byte [ux_mem + 36930], 82
    mov byte [ux_mem + 36931], 61
    mov byte [ux_mem + 36932], 0
    mov byte [ux_mem + 36936], 83
    mov byte [ux_mem + 36937], 72
    mov byte [ux_mem + 36938], 76
