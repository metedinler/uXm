...
uxm_entry:
    ...
    mov byte [ux_mem + 73729], 84
    mov byte [ux_mem + 73730], 71
    mov byte [ux_mem + 73731], 84
    mov byte [ux_mem + 73732], 84
    mov byte [ux_mem + 73733], 84
    mov byte [ux_mem + 73734], 84
    mov byte [ux_mem + 73735], 65
    mov byte [ux_mem + 73736], 65
    mov byte [ux_mem + 73737], 0
    ; >
    inc rbx
    cmp rbx, TAPE_CELLS
    jae __ux_err_ptr
