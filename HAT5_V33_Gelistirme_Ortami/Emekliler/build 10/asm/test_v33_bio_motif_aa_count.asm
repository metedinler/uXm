...
uxm_entry:
    ...
    mov byte [ux_mem + 73728], 65
    mov byte [ux_mem + 73729], 67
    mov byte [ux_mem + 73730], 71
    mov byte [ux_mem + 73731], 84
    mov byte [ux_mem + 73732], 65
    mov byte [ux_mem + 73733], 67
    mov byte [ux_mem + 73734], 71
    mov byte [ux_mem + 73735], 84
    mov byte [ux_mem + 73736], 0
    mov byte [ux_mem + 73744], 71
    mov byte [ux_mem + 73745], 84
    mov byte [ux_mem + 73746], 0
    mov byte [ux_mem + 73760], 77
    mov byte [ux_mem + 73761], 70
    mov byte [ux_mem + 73762], 77
    mov byte [ux_mem + 73763], 77
    mov byte [ux_mem + 73764], 0
    ; >
    inc rbx
    cmp rbx, TAPE_CELLS
    jae __ux_err_ptr
