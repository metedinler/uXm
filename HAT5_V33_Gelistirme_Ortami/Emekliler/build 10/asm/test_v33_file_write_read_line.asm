...
uxm_entry:
    ...
    mov byte [ux_mem + 73728], 117
    mov byte [ux_mem + 73729], 120
    mov byte [ux_mem + 73730], 109
    mov byte [ux_mem + 73731], 95
    mov byte [ux_mem + 73732], 115
    mov byte [ux_mem + 73733], 116
    mov byte [ux_mem + 73734], 97
    mov byte [ux_mem + 73735], 103
    mov byte [ux_mem + 73736], 101
    mov byte [ux_mem + 73737], 53
    mov byte [ux_mem + 73738], 95
    mov byte [ux_mem + 73739], 108
    mov byte [ux_mem + 73740], 105
    mov byte [ux_mem + 73741], 110
    mov byte [ux_mem + 73742], 101
    mov byte [ux_mem + 73743], 46
    mov byte [ux_mem + 73744], 116
    mov byte [ux_mem + 73745], 109
    mov byte [ux_mem + 73746], 112
    mov byte [ux_mem + 73747], 0
    mov byte [ux_mem + 73760], 72
    mov byte [ux_mem + 73761], 69
    mov byte [ux_mem + 73762], 76
    mov byte [ux_mem + 73763], 76
    mov byte [ux_mem + 73764], 79
    mov byte [ux_mem + 73765], 0
    mov byte [ux_mem + 73792], 69
    mov byte [ux_mem + 73793], 77
    mov byte [ux_mem + 73794], 80
    mov byte [ux_mem + 73795], 84
    mov byte [ux_mem + 73796], 89
    mov byte [ux_mem + 73797], 0
    ; >
    inc rbx
    cmp rbx, TAPE_CELLS
    jae __ux_err_ptr
