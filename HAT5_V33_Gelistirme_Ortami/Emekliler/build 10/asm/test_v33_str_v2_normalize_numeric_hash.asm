...
uxm_entry:
    ...
    mov byte [ux_mem + 73729], 32
    mov byte [ux_mem + 73730], 32
    mov byte [ux_mem + 73731], 66
    mov byte [ux_mem + 73732], 9
    mov byte [ux_mem + 73733], 67
    mov byte [ux_mem + 73734], 0
    mov byte [ux_mem + 73760], 49
    mov byte [ux_mem + 73761], 50
    mov byte [ux_mem + 73762], 51
    mov byte [ux_mem + 73763], 52
    mov byte [ux_mem + 73764], 53
