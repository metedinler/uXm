...
uxm_entry:
    ...
    mov byte [ux_mem + 40960], 77
    mov byte [ux_mem + 40961], 101
    mov byte [ux_mem + 40962], 114
    mov byte [ux_mem + 40963], 104
    mov byte [ux_mem + 40964], 97
    mov byte [ux_mem + 40965], 98
    mov byte [ux_mem + 40966], 97
    mov byte [ux_mem + 40967], 32
    mov byte [ux_mem + 40968], 85
    mov byte [ux_mem + 40969], 88
    mov byte [ux_mem + 40970], 45
    mov byte [ux_mem + 40971], 77
    mov byte [ux_mem + 40972], 73
    mov byte [ux_mem + 40973], 78
    mov byte [ux_mem + 40974], 73
    mov byte [ux_mem + 40975], 77
    mov byte [ux_mem + 40976], 65
    mov byte [ux_mem + 40977], 32
    mov byte [ux_mem + 40978], 86
    mov byte [ux_mem + 40979], 51
    mov byte [ux_mem + 40980], 46
    mov byte [ux_mem + 40981], 49
    mov byte [ux_mem + 40982], 10
