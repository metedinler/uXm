...
uxm_entry:
    ...
    mov byte [ux_mem + 40960], 52
    mov byte [ux_mem + 40961], 32
    mov byte [ux_mem + 40962], 78
    mov byte [ux_mem + 40963], 69
    mov byte [ux_mem + 40964], 85
    mov byte [ux_mem + 40965], 82
    mov byte [ux_mem + 40966], 79
    mov byte [ux_mem + 40967], 78
    mov byte [ux_mem + 40968], 32
    mov byte [ux_mem + 40969], 78
    mov byte [ux_mem + 40970], 78
    mov byte [ux_mem + 40971], 32
    mov byte [ux_mem + 40972], 84
    mov byte [ux_mem + 40973], 69
    mov byte [ux_mem + 40974], 83
    mov byte [ux_mem + 40975], 84
    mov byte [ux_mem + 40976], 10
    mov byte [ux_mem + 40977], 0
    mov byte [ux_mem + 40992], 88
    mov byte [ux_mem + 40993], 49
    mov byte [ux_mem + 40994], 61
    mov byte [ux_mem + 40995], 0
    mov byte [ux_mem + 41000], 32
    mov byte [ux_mem + 41001], 88
    mov byte [ux_mem + 41002], 50
    mov byte [ux_mem + 41003], 61
    mov byte [ux_mem + 41004], 0
    mov byte [ux_mem + 41008], 10
    mov byte [ux_mem + 41009], 0
    mov byte [ux_mem + 41016], 78
    mov byte [ux_mem + 41017], 49
    mov byte [ux_mem + 41018], 61
    mov byte [ux_mem + 41019], 0
    mov byte [ux_mem + 41024], 32
    mov byte [ux_mem + 41025], 78
    mov byte [ux_mem + 41026], 50
    mov byte [ux_mem + 41027], 61
    mov byte [ux_mem + 41028], 0
    mov byte [ux_mem + 41032], 32
    mov byte [ux_mem + 41033], 78
    mov byte [ux_mem + 41034], 51
    mov byte [ux_mem + 41035], 61
    mov byte [ux_mem + 41036], 0
    mov byte [ux_mem + 41040], 32
    mov byte [ux_mem + 41041], 79
    mov byte [ux_mem + 41042], 85
    mov byte [ux_mem + 41043], 84
    mov byte [ux_mem + 41044], 61
    mov byte [ux_mem + 41045], 0
    ; p1
    mov ecx, 0
    mov edx, CELL_BITS
